...
Data was downloaded from both sites.  However, the csv file form the EPA site was corrupted, and when imported, did not reliably
...
At nearly one GB in size, the single file was far too massive to manage and so we addresses the following issues while reorganizing the data:
...
We then split the dataframe into 613 dataframes housing the data for each unique chemical, and stored these as individual csv files.
* Each individual dataframe contained the 66 columns related to fate, and the chemical file names were coded according to chemical
name, which meant that the process of querying any indivdual chemical could be fairly well automated.  A lookup function queried the monster
file for chemical names, keeping these readily available for any routines that searched across the span of files.

### Start the EDA...
<table>
<tr><td align="center">Some of the 630 chemicals<img src="/figs/ind_chem_long_jn.png" alt = "chemical in TRI" height="420" width="200"></td>
<td align="center">New individual csv files
...
<tr><td colspan=2 align="center"><center>Cross section of fate data for Benzene</center>
...
<table>
<tr><td align="center">A few graphs showing fate over time
